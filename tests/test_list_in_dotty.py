...
# SNAGED FROM https://github.com/pawelzny/dotty_dict/blob/98984911a61ae9f1aa4da3f6c4808da991b89847/tests/test_list in to_data.py
...
class TestListInDotty(unittest.TestCase):
    def setUp(self):
        self.dot = to_data({
            ...
            "field4": "Not wanted",
            "field5": [{"subfield1": [{
                "subsubfield": "Value of sub subfield (item 0)"
            }]}],
            "field6": ["a", "b"],
        })
    ...
    def test_access_sub_sub_field(self):
        self.assertEqual(
            self.dot["field5.0.subfield1.0.subsubfield"],
            "Value of sub subfield (item 0)",
        )
    ...
    def test_delete_subfield(self):
        ...
        self.assertDictEqual(
            dot.to_dict(), {"field": [{"subfield1": "Value of subfield1 (item 0)"},]}
        )

    def test_list_as_return_value(self):
        dot = to_data({"field": ["list_field0", "list_field1"]})
...
class TestMultipleSelectList(unittest.TestCase):
    ...
    def test_whole_nested_multiple_list(self):
        ...
        self.assertListEqual(
            self.dot["field2.:.subfield1.:.nestedsubfield1"], expected_list
        )
